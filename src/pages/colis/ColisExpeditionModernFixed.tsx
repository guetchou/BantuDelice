...
const ColisExpeditionModernFixed: React.FC = () => {
  ...
  const calculatePrice = async () => {
    ...
    try {
      ...
      const calculation = TarifService.calculateTarif({
        ...
        weight,
        service: formData.service,
        isInternational: formData.serviceType === 'international',
        isFragile: formData.packageType === 'fragile',
        isUrgent: formData.packageType === 'heavy',
        insuranceValue: formData.insurance ? parseFloat(formData.insuranceValue || '0') : 0,
        deliveryType: formData.recipient.deliveryType
      });
  ...
  const handleSubmit = async () => {
    ...
    localStorage.setItem('expeditionData', JSON.stringify(formData));
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            Sélectionnez l'agence où vous souhaitez déposer votre colis
                          </p>
                        </div>
                  ...
                  <div className="space-y-4">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-500 mt-1">
                        Zone: {priceCalculation.zone.name}
                      </div>
                    </div>
