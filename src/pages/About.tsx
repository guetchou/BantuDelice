  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <SEO 
        ...
        description="Découvrez l'histoire de Buntudelice, notre mission et nos valeurs. Nous sommes dédiés à fournir des services de qualité à Kinshasa et dans toute la RDC."
        keywords="à propos, Buntudelice, histoire, mission, valeurs, Kinshasa, RDC"
      />
      ...
      <div className="bg-gradient-to-r from-primary/20 to-primary/5 rounded-xl p-8 mb-16 flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/2 mb-8 lg:mb-0">
          ...
          <p className="text-lg mb-6">
            ...
            des habitants de Kinshasa et de toute la République Démocratique du Congo.
          </p>
          <Button asChild>
      ...
      <div className="mb-16">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <div className="prose max-w-none">
            <p>
              L'idée de Buntudelice est née d'un constat simple : dans les grandes villes africaines comme Kinshasa, 
      ...
      <div className="text-center mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600">123 Avenue du Commerce, Gombe, Kinshasa, RDC</p>
          </div>
          <div className="flex flex-col items-center">
            <div className="mb-4 bg-primary/10 p-4 rounded-full">
