...
const TaxiHistoryView: React.FC<TaxiHistoryViewProps> = ({ userId }) => {
  ...
  useEffect(() => {
    const mockRides: TaxiRide[] = [
      {
        id: '1',
        pickup_address: 'Gombe, Brazzaville',
        destination_address: 'Limete, Brazzaville',
        status: 'completed',
        price: 15000,
        distance: 12,
        duration: 25,
      ...
      {
        id: '2',
        pickup_address: 'Bandalungwa, Brazzaville',
        destination_address: 'Kintambo, Brazzaville',
        status: 'completed',
        price: 8000,
        distance: 6,
        duration: 15,
      ...
      {
        id: '3',
        pickup_address: 'Matete, Brazzaville',
