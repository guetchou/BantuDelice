...
export default function TaxiRide() {
  ...
  const [rideStatus, setRideStatus] = useState<RideStatus>({
    status: 'searching',
    estimatedTime: 5,
    currentLocation: [15.2429, -4.2634]
  });
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-semibold text-gray-900">Suivi de course</h1>
            </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                {rideStatus.status === 'searching' && (
                  <Button variant="outline" onClick={() => navigate('/taxi')}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">123 Rue de la Paix, Brazzaville</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">456 Avenue du Commerce, Brazzaville</p>
                    </div>
                  </div>
                </div>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center space-y-4">
                  ...
                  <div className="flex space-x-2">
                    <Button onClick={() => navigate('/taxi')} className="flex-1">
                      Noter la course
                    </Button>
                    <Button variant="outline" onClick={() => navigate('/taxi')} className="flex-1">
                      Nouvelle course
                    </Button>
                  </div>
                </div>
