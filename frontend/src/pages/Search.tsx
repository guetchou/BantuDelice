  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <SEO 
        ...
        description={`Résultats de recherche pour "${searchQuery}" - Restaurants, taxis et services à Brazzaville`}
        keywords={`recherche, ${searchQuery}, restaurants, taxi, Brazzaville`}
      />
